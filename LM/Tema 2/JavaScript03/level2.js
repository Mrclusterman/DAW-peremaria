...
if(date.getMinutes() < 10){
    let level3 = `${date.getFullYear()}-${date.getMonth()}-${date.getDate()} ${date.getHours()}-0${date.getMinutes()}-${date.getSeconds()}`;
}
else{
    let level3 = `${date.getFullYear()}-${date.getMonth()}-${date.getDate()} ${date.getHours()}-${date.getMinutes()}-${date.getSeconds()}`;
}
